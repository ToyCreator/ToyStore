  ...
  return (
    <div className="footer">
      ...
      <div className="footer-social">
        <a href="https://elasticthemes.com" target="_blank" rel="noreferrer" className="footer-social-link w-inline-block">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-right">
          ...
          <a href="/template/style-guide" className="link-white">Style Guide</a>
          <div className="footer-bottom-divider"></div>
          <a href="/template/licensing" className="link-white">Licensing</a>
        </div>
      </div>
    </div>
  )
